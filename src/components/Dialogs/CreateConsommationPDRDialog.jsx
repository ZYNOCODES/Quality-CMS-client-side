...
export default function ConsommationPDRDialog(props) {
        ...
        if (confirmation) {
            try {
                ...
                if (error.response) {
                    ...
                    console.error("Error creating Consommation PDR: No response received");
                } else {
                    // Something happened in setting up the request that triggered an Error
                    console.error("Error creating Consommation PDR", error);
                }
            }
            setconfirmation(false);
            setQuantity('');
    ...
    return (
        ...
        >
            {!loading && 
                <>
                    <DialogTitle>Creation d'une comsommation PDR</DialogTitle>
                    <DialogContent>
                        <DialogContentText>
