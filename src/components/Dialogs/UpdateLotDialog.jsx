...
export default function UpdateLotDialog(props) {
    ...
    const handleOnUpdate = async () => {
        ...
        if (confirmation) {
            try {
                setLoading(true);
                const response = await axios.patch(import.meta.env.VITE_APP_URL_BASE+`/lot/update/${props.code}`, 
                    {
                        name: Name
                    },
                    {
                ...
                if (error.response) {
                    ...
                    console.error("Error updating lot: No response received");
                } else {
