...
export default function UpdateFamilyDialog(props) {
    ...
    const handleOnUpdate = async (event) => {
        ...
        if (confirmation) {
            try {
                setLoading(true);
                const response = await axios.patch(import.meta.env.VITE_APP_URL_BASE+`/family/${props.code}`, 
                    {
                        name: Name
                    },
                    {
                ...
                if (error.response) {
                    ...
                    console.error("Error updating family: No response received");
                } else {
                ...
                <>
                    ...
                    <DialogContent>
                        ...
                        <TextField
                            ...
                            id="name"
                            name="Nom"
                            label="Entrez le nom de la famille"
                            type="text"
                            fullWidth
                            variant="standard"
