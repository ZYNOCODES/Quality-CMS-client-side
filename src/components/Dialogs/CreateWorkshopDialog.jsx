...
export default function WorkshopDialog(props) {
    ...
    const onUploadXLSXFile = async (formData) => {
        try {
          ...
          const response = await axios.post(import.meta.env.VITE_APP_URL_BASE+`/xlsx/upload/workshop`, 
            formData, 
            {
              headers: {
          ...
          if (error.response) {
            ...
            // Request was made but no response was received
            console.error("Error importing workshops: No response received");
          } else {
            // Something happened in setting up the request that triggered an Error
    ...
    return (
        ...
        <ConfirmationUploadExcelDialog
            ...
            name="d'insertion des ateliers à partir d'un fichier Excel"
        ...
        <NonSavedXLSXDisplayerDialog
            ...
            name="Les ateliers non sauvegardés"
            loading={submitionLoading}
