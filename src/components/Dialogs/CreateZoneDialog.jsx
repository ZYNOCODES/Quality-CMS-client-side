...
export default function ZoneDialog(props) {
  ...
  const onUploadXLSXFile = async (formData) => {
    try {
      ...
      const response = await axios.post(import.meta.env.VITE_APP_URL_BASE+`/xlsx/upload/zone`, 
        formData, 
        {
          headers: {
  ...
  >
      ...
      <ConfirmationUploadExcelDialog
        ...
        name="d'insertion des zones à partir d'un fichier Excel"
      ...
      <NonSavedXLSXDisplayerDialog
        ...
        name="Les zones non sauvegardés"
        loading={submitionLoading}
